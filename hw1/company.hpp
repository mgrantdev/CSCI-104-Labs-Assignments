...
private:
  ...
  void deleteAllParentsAndItself(Company* company);

  // check if the company's memory has already been freed to avoid more than one delete
  bool inFreed(Company* company);
};
